...
const PROJECT_LIST: ICard[] = [
  {
    id: 1,
    imageUrl: getImageUrl('chatting.png'),
    title: '채팅 어플리케이션',
    subTitle: '데스크탑 채팅 어플리케이션',
    desc: '데스크탑에 설치하여 사용하는 채팅 어플리케이션 입니다. \n\n React를 사용해 데스크탑 어플리케이션을 구현해 보는 경험을 하였습니다. \n\n React, Typescript, Scss, Nextron을 사용하였습니다.',
    link: 'https://github.com/jeonhaekang/desktop_chat_app',
  },
  {
    id: 2,
    ...
    title: '포트폴리오',
    subTitle: '포트폴리오 사이트',
    desc: '현재 보시고 계시는 사이트입니다.\n\n 인터렉션 등 애니메이션 기능을 구현해 보는 연습을 진행하였으며.\n 반응형 웹 사이트로 구성되어 있습니다. \n\n Typescript, Next.js를 경험하였습니다. \n\n 현재는 원페이지 이지만 추후 확장성을 고려해 SEO에 유리한 Next.js를 채택하였습니다.  \n\n React, Typescript, Scss, Next.js를 사용하였습니다.',
